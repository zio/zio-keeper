package zio.membership.discovery
...
import zio.membership.ServiceDiscoveryError
...
trait K8DnsDiscovery extends Discovery.Service[Any] {
  ...
  final override val discoverNodes: ZIO[Any, ServiceDiscoveryError, Set[SocketAddress]] = {
    for {
